  export class LoginPage 
  {
   enterLoginCredentials = function () {
     ...
     expect(cy.contains('Email or Phone').click().type('abhi.cal2008@gmail.com'));
     ...
     expect(cy.contains('Email address or phone number').click({ force:true }).type('abhi.cal2008@gmail.com'));
     expect(cy.contains('Password'),"Text is missing");
     expect(cy.contains('Password').click({ force:true }).type('ayushbose@2002'));
   ...
   submitCredentials = function () {
    ...
    expect(cy.contains('Password').click().type('ayushbose@2002'));
